...
public class FragmentNinth extends Fragment {
    ...
    public static FragmentNinth newInstance(int fragNumber){
       FragmentNinth fragment = new FragmentNinth();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imgBanner9 = view.findViewById(R.id.imgBanner9);
        tvName9 = view.findViewById(R.id.tvName9);
        tvName9.setText("Page" + fragNumber);
